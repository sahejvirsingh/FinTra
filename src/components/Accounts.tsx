...
import { Account, iconMap, Currency, SupportedCurrencies } from "../types";
...
const Accounts = ({
  ...
  const currencySymbol =
    profile?.currency && SupportedCurrencies[profile.currency].symbol; // Hardcoded for now, should come from context
  return (

...
const Avatar = ({ name }: { name: string }) => (
  <div className="h-8 w-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold text-sm select-none">
    {getInitials(name)}
  </div>
);
    ...
    return (
        <div className="relative" ref={menuRef}>
            ...
            >
                ...
                <span className="hidden sm:inline font-semibold text-sm text-gray-700 dark:text-gray-200">{profile.full_name}</span>
